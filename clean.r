...
library(xlsx)
getwd()
setwd("D:/Users/skywayoo/Desktop/trainset")
...
setwd("D:/Users/skywayoo/Desktop/trainset/Business_Industrial")
BIpath <- DirSource("D:/Users/skywayoo/Desktop/trainset/Business_Industrial")
BI <- data.frame()
...
setwd("D:/Users/skywayoo/Desktop/trainset/Computers_Consumer_Electronics")
CCEpath <- DirSource("D:/Users/skywayoo/Desktop/trainset/Computers_Consumer_Electronics")
CCE <- data.frame()
...
write.csv(CCE,file="CCE.csv")
#Finance give label
setwd("D:/Users/skywayoo/Desktop/trainset/Finance")
Fpath <- DirSource("D:/Users/skywayoo/Desktop/trainset/Finance")
Finance <- data.frame()
...
write.csv(Finance,file="Finance.csv")

#Jobs_Education give label
setwd("D:/Users/skywayoo/Desktop/trainset/Jobs_Education")
JEpath <- DirSource("D:/Users/skywayoo/Desktop/trainset/Jobs_Education")
JE <- data.frame()
